------------------------------------------------
-- This Source Was Developed By (aSr) @PPPPPE.--
--   This Is The Source Channel @pplllp .   --
--                - TorNaDo-                 --
--        -- https://t.me/pplllp --         --
------------------------------------------------ 
...
return {
Lock     = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[TorNaDo](https://t.me/pplllp)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
{
{text = 'TorNaDo ⁦', url='https://t.me/pplllp'},
},
}
}
...
download('raw.githubusercontent.com/Tornadoo1/BlackPink/main/BlackPink.lua','BlackPink.lua')
...
{{text =news,url = "https://t.me/pplllp"}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/pplllp'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
data = {
{
{text = '- قناة السورس', url = 't.me/pplllp'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/pplllp'}, 
},
{
{text = 'My Channel', url = 't.me/plllpp'}, 
},
{
{text = 'Bot Source', url = 't.me/TornadooBot'}, 
},
{
...
data = {
{
{text = '᥀ السورس .', url = 't.me/pplllp'},{text = '᥀ لتنصيب بوت .', url = 't.me/aSsSsr'}, 
},
{
